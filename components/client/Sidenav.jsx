...
const Sidenav = () => {
  ...
  const handlePost = (image) => {
    ...
    if (
      ...
      platforms
        .map((p) => p.toLowerCase())
        .includes(platformChoice.toLowerCase())
    ) {
    ...
    const fetchImages = async () => {
      try {
        ...
        const response = await fetch(
          `/api/images/${currentuser.id}/client_images`,
          {
            method: "GET",
  ...
  return (
    <section
      ...
      } flex gap-6 min-h-screen transition-colors duration-300`}
    >
      {/* Sidebar Menu */}
      <div
        className={`${
          ...
          {menus.map((menu, i) => (
            ...
            >
              <Link
                ...
                className={`${
                  menu?.margin && "mt-5"
                } flex items-center text-sm gap-3.5 font-medium p-3 
              ...
              >
                <div
                  className={`${i === 6 && darkMode ? "text-yellow-400" : ""}`}
                >
      ...
      <div className="flex-1 p-6 md:p-8 w-full overflow-x-hidden">
        <div className="m-4 py-6">
          ...
          {activeSection === "unpaid" && (
            <>
              <h2 className="px-4 text-xl font-semibold mb-4">
                Available Photos
              </h2>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 px-4">
                {clientimages && Array.isArray(clientimages) ? (
                  clientimages
                        ...
                        <div className="aspect-w-3 aspect-h-4">
                          <img
                            ...
                            onError={(e) => {
                              ...
                              e.target.src = "/placeholder-image.jpg"; // Replace with a placeholder image path
                            }}
                          />
                        </div>
                  ...
                  {paidImages.map((image, index) => (
                    <div
                      ...
                      className={`relative overflow-hidden ${
                        darkMode ? "bg-gray-800" : "bg-gray-100"
                      } rounded-xl shadow-md group transition-all hover:shadow-xl`}
                    >
                      <div
                      ...
                      <div className="absolute top-2 right-2 opacity-0 group-hover:opacity-100 transition-opacity">
                        <span
                          ...
                          } text-sm px-2 py-1 rounded shadow-md`}
                        >
                          Click to view
                        </span>
                      </div>
      ...
      {isPaymentModalOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-75 flex justify-center items-center z-50 p-4">
          <div
            className={`relative ${
              darkMode ? "bg-gray-800" : "bg-white"
            } p-6 rounded-xl max-w-md w-full shadow-2xl`}
          >
            <button
            ...
            {selectedImageForPayment && (
              <div className="mb-4">
                ...
                />
                <p className="mb-4">
                  Purchase this photo to view, download, and share it.
                </p>
                <div className="mb-6">
          ...
          <div className="relative max-w-5xl w-full max-h-screen">
            ...
            <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 bg-black bg-opacity-50 px-6 py-3 rounded-full flex gap-6">
              ...
              <button
                ...
                className={`${
                  likedImages.includes(lightboxImage)
                    ? "text-red-500"
                    : "text-white"
